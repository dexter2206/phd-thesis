...
While the above procedure is useful conceptually, it clearly cannot be directly used
...
To prevent this, a sequence of truncation is performed, which results in a series of boundary
