...
find the optimal solution, although with different frequencies. Summary of
parameters for which the ground state was obtained is presented in table
\ref{tab:line216ground}.
